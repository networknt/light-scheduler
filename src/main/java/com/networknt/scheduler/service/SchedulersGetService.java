...
public class SchedulersGetService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(SchedulersGetService.class);
