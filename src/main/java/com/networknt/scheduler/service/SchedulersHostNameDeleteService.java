...
public class SchedulersHostNameDeleteService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(SchedulersHostNameDeleteService.class);
