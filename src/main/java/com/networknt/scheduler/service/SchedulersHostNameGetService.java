...
public class SchedulersHostNameGetService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(SchedulersHostNameGetService.class);
