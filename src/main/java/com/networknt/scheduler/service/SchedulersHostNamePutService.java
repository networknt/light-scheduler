...
public class SchedulersHostNamePutService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(SchedulersHostNamePutService.class);
