...
public class SchedulersIdDeleteService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(SchedulersIdDeleteService.class);
