...
public class SchedulersIdPutService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(SchedulersIdPutService.class);
