...
@Ignore
public class SchedulersHostNameGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(SchedulersHostNameGetHandlerTest.class);
    ...
    @Test
    public void testSchedulersHostNameGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/schedulers/vXytF/vXytF";
