...
@Ignore
public class SchedulersIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(SchedulersIdGetHandlerTest.class);
    ...
    @Test
    public void testSchedulersIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/schedulers/GGZCeEkRJlRlXLWZHjDooZUCPd";
